...
public class TestGridDrageRecyclerViewActivity extends BaseActivity {
    ...
    public void setupView() {
        menuRecyclerView = UIUtil.findViewById(this, R.id.test_swipe_rv);
    }
    ...
    public void addListener() {
        ...
        menuRecyclerView.setOnItemMoveListener(new MyOnItemMovedListener());
        menuRecyclerView.setOnItemStateChangedListener(new MyOnItemStateChangedListener(this));
    }
    ...
    private class MyOnItemStateChangedListener implements OnItemStateChangedListener {
        ...
        public MyOnItemStateChangedListener(Context context) {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (actionState == OnItemStateChangedListener.ACTION_STATE_DRAG) {
                ...
                viewHolder.itemView.setBackgroundColor(ContextCompat.getColor(context, R.color.white_pressed));
            } else if (actionState == OnItemStateChangedListener.ACTION_STATE_SWIPE) {

            } else if (actionState == OnItemStateChangedListener.ACTION_STATE_IDLE) {

                // 在手松开的时候还原背景。
                ViewCompat.setBackground(viewHolder.itemView, ContextCompat.getDrawable(context, R.drawable.select_white));
            }
        }
    }
