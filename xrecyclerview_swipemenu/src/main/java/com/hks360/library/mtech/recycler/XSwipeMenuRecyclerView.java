...
public class XSwipeMenuRecyclerView extends XRecyclerView {
    ...
    public XSwipeMenuRecyclerView(Context context) {
        this(context, null);
    }

    public XSwipeMenuRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XSwipeMenuRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void smoothOpenMenu(int position, @DirectionMode int direction, int duration) {
        ...
        RecyclerView.ViewHolder vh = findViewHolderForAdapterPosition(position);
        if (vh != null) {
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN: {
                    ...
                    if (isIntercepted) {
                        ...
                        RecyclerView.ViewHolder vh = findViewHolderForAdapterPosition(touchingPosition);
                        if (vh != null) {
                            View itemView = getSwipeMenuView(vh.itemView);
                            if (itemView instanceof SwipeMenuLayout) {
                                mOldSwipedLayout = (SwipeMenuLayout) itemView;
