...
import com.hks360.library.mtech.swipe.ResCompat;
...
public class ListViewDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListViewDecoration(Context context , int drawableResId) {
        mDrawable = ResCompat.getDrawable(context, drawableResId);
    }
