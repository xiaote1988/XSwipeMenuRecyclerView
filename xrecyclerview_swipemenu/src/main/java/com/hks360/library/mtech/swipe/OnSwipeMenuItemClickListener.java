...
public interface OnSwipeMenuItemClickListener {
     ...
     * @param direction       can be {@link Direction#LEFT}, {@link Direction#RIGHT}.
     */
    void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, @DirectionMode int direction);
