package com.hks360.library.mtech.widget;
...
import com.hks360.library.mtech.progressindicator.AVLoadingIndicatorView;
...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
	...
	private void initView() {
		...
		mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
				R.layout.xrecycler_header, null);
    ...
    public void setProgressView(View refreshView){
        mProgressBar.setView(refreshView);
    }
