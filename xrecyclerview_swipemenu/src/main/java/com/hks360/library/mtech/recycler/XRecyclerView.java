...
import com.hks360.library.mtech.listener.AppBarStateChangeListener;
import com.hks360.library.mtech.listener.OnItemClickListener;
import com.hks360.library.mtech.listener.OnLoadingListener;
import com.hks360.library.mtech.widget.ArrowRefreshHeader;
import com.hks360.library.mtech.widget.LoadingMoreFooter;
...
public class XRecyclerView extends RecyclerView {
    private static final String VIEW_TYPE_ERROR =
    ...
    public void setNoMore(boolean noMore) {
        ...
        isNoMore = noMore;
        if (mFootView instanceof LoadingMoreFooter) {
            ((LoadingMoreFooter) mFootView).setState(isNoMore ? LoadingMoreFooter.STATE_NOMORE : LoadingMoreFooter
                    .STATE_COMPLETE);
        } else {
            mFootView.setVisibility(View.GONE);
        }
    ...
    public void setRefreshProgressView(View view) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setProgressView(view);
        }
    }
            ...
            if (layout instanceof GridLayoutManager) {
                ...
                gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                    ...
                    public int getSpanSize(int position) {
                        return (mWrapAdapter.isHeader(position) || mWrapAdapter.isFooter(position) || mWrapAdapter
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData &&
            ...
            if (layoutManager.getChildCount() > 0
                    ...
                    layoutManager.getChildCount() && !isNoMore && mRefreshHeader.getState() < ArrowRefreshHeader
                    .STATE_REFRESHING) {
                isLoadingData = true;
                if (mFootView instanceof LoadingMoreFooter) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isOnTop() && pullRefreshEnabled && appbarState == AppBarStateChangeListener.State.EXPANDED) {
                    ...
                    if (mRefreshHeader.getVisibleHeight() > 0 && mRefreshHeader.getState() < ArrowRefreshHeader
                            .STATE_REFRESHING) {
                        return false;
                    }
                }
            ...
            if (adapter != null) {
                ...
                if (adjPosition < adapterCount) {
                    ...
                    if (isReservedItemViewType(type)) {
                        throw new IllegalStateException(VIEW_TYPE_ERROR);
                    }
                    return type;
                }
            }
